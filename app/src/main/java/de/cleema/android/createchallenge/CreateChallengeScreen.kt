...
fun CreateChallengeScreen(
    ...
    Column(
        ...
        when (val state = uiState) {
            ...
            is Edit -> CreateChallenge(state = state.editChallenge, onChangeState = viewModel::edit)
...
fun CreateChallengeUiState.nextButtonTitle(): String? = when (this) {
    ChooseTemplate -> null
    Done -> null
    is Edit -> if (this.canInviteFriends) stringResource(R.string.create_challenge_next_button) else stringResource(R.string.create_challenge_save)
    is Error -> null
